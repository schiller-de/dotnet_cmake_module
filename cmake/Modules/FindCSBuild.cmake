...
if(MSVC)
    ...
    if(IS_ARM GREATER -1)
        set(DOTNET_CORE_ARCH "arm" CACHE STRING)
    endif()
...
if(NOT DOTNET_CORE_ARCH)
    if(CMAKE_SIZEOF_VOID_P EQUAL "4" OR FORCE_X86)
        ...
        set(DOTNET_CORE_ARCH "x86" CACHE STRING)
    elseif(CMAKE_SIZEOF_VOID_P EQUAL "8")
        if(MONO_FOUND AND "${MONO_VERSION}" VERSION_LESS "2.10.10")
            ...
            set(DOTNET_CORE_ARCH "x64" CACHE STRING)
        endif()
    else()
...
if(DOTNET_CORE_FOUND)
    ...
    set(DOTNET_CORE_RUNTIME "${DOTNET_CORE_PLATFORM}-${DOTNET_CORE_ARCH}" CACHE STRING)
endif()
