...
if(MSVC)
    ...
    if(IS_ARM GREATER -1)
        set(DOTNET_CORE_RUNTIME "${DOTNET_CORE_RUNTIME}-arm")
    endif()
elseif(CMAKE_SYSTEM_PROCESSOR STREQUAL "arm")
    set(DOTNET_CORE_RUNTIME "${DOTNET_CORE_RUNTIME}-arm")
endif()

if(NOT DOTNET_CORE_RUNTIME)
    if(CMAKE_SIZEOF_VOID_P EQUAL "4" OR FORCE_X86)
        ...
        set(DOTNET_CORE_RUNTIME "${DOTNET_CORE_RUNTIME}-x86")
    elseif(CMAKE_SIZEOF_VOID_P EQUAL "8")
        if(MONO_FOUND AND "${MONO_VERSION}" VERSION_LESS "2.10.10")
            ...
            set(DOTNET_CORE_RUNTIME "${DOTNET_CORE_RUNTIME}-x64")
        endif()
    else()
